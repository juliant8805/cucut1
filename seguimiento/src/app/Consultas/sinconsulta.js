...
function general() {
    ...
    if (document.getElementById("barrio").value !== '') {
        ...
        select[3] = "<b>Área</b>";
        select[4] = "<b>Parques</b>";
        select[5] = "<b>Colegios</b>";
        select[6] = "<b>Centros de Salud</b>";
        select[7] = "<b>Escenarios Deportivos</b>";
        select[8] = "<b>Número de Arboles</b>";
        select[9] = "<b>Avalúo Catastral</b>";
        sel[0] = values;
        sel[1] = totalprediosbarrio;
        sel[2] = manzanasbarrio.length;
        sel[3] = areabarrios + "&nbsp;&nbsp;Metros Cuadrados";
        sel[4] = "PENDIENTE";
        sel[5] = "PENDIENTE";
        sel[6] = "PENDIENTE";
        sel[7] = "PENDIENTE";
    ...
    /* else if(document.getElementById("inputbarriototem").value !== ''){
     ...
     document.getElementById("botonminimizar").style.display = "block";    
        ...
        var cell1 = row.insertCell(0);
        cell1.colSpan = 2;
        cell1.innerHTML = "<H5><b>INFORMACION DE LA MANZANA</b></H5>";
        var select = [];
        var sel = [];
