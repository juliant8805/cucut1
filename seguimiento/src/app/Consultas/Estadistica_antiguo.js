function estdistica(select, titulo, param, totales) {
    ...
    for (i = 0; i < param.length; i++) {
        if (param[i][0]==='PH'){
            ...
            color[i]='#BFBFBF';    
        }else if(param[i][0]==='1-1.000.000'){
            color[i]='#A3FF73';    
        }else if(param[i][0]==='1.000.001-10.000.000'){
            color[i]='#6699CD';    
        }else if(param[i][0]==='10.000.001-100.000.000'){
            color[i]='#C29ED7';    
        }else if(param[i][0]==='>100.000.000'){
            color[i]='#FF0000';    
        }else if(param[i][0]==='PREDIOS DEL MUNICIPIO'){
            color[i]='#D8D8D8';    
        }else if(param[i][0]==='SIN DEUDA'){
            color[i]='#B2B2B2';    
        }else if(param[i][0]==='ACUERDO DE PAGO'){
            color[i]='#333333';    
        }
